...
/**
 * Esta clase será solo para la conexion a la base de datos
...
public class OracleJDBC {
	...
	//cambiar nombre main a abrir que te va a devolver un objeto Connection
	//Devolverá null o Connection
	...
	/**
	 * crear un método para dejar la conn abierta y solo cuando llamen cierra la conexión
	 * @throws SQLException 
	 */
